...
use LightPHP\Core\Exception\PHPException;
use LightPHP\Tool\Debug\PHPFatalException;
    ...
    public static function registerErrorHandling()
    {
        ...
        if (lpRunLevel <= lpProduction) {
            ...
            set_exception_handler(function (\Exception $exception) {
                ...
                if (lpRunLevel >= lpDebug && $exception instanceof PHPException) {
                    // 用于打印符号表的函数
            ...
            register_shutdown_function(function () {
                ...
                if ($error && in_array($error["type"], [E_ERROR, E_PARSE, E_CORE_ERROR, E_COMPILE_ERROR, E_RECOVERABLE_ERROR])) {
                    ...
                    if ($exceptionHandler !== null)
                        call_user_func($exceptionHandler, new PHPFatalException($error['message'], $error['type'], 0, $error['file'], $error['line']));
                    exit;
                }
            });
        }
